    ...
    Prism = function () {
        var b = /\blang(?:uage)?-([\w-]+)\b/i,
            ...
            c = _self.Prism = {
                    ...
                    clone: function (a, f) {
                        ...
                        switch (f = f || {}, g) {
                            case "Object":
                                ...
                                var b = {};
                                for (var d in f[c.util.objId(a)] = b, a) a.hasOwnProperty(d) && (b[d] = c.util.clone(a[d], f));
                                return b;
                            case "Array":
                                return f[c.util.objId(a)] ? f[c.util.objId(a)] : (b = [], f[c.util.objId(a)] = b, a.forEach((function (a, g) {
                ...
                languages: {
                    extend: function (a, f) {
                        for (var g in a = c.util.clone(c.languages[a]), f) a[g] = f[g];
                        return a
                    },
                    insertBefore: function (a, f, g, b) {
                        var l = (b = b || c.languages)[a];
                        if (2 == arguments.length) {
                            for (var d in g = arguments[1]) g.hasOwnProperty(d) && (l[d] = g[d]);
                            return l
                        }
                        var e = {},
                            k;
                        for (k in l)
                            if (l.hasOwnProperty(k)) {
                                ...
                                e[k] = l[k]
                            } return c.languages.DFS(c.languages, (function (f, c) {
                            c === b[a] && f != a && (this[f] = e)
                        })), b[a] = e
                    },
                    DFS: function (a, f, g, b) {
                        for (var d in b = b || {}, a) a.hasOwnProperty(d) && (f.call(a, d, a[d], g || d), "Object" !== c.util.type(a[d]) || b[c.util.objId(a[d])] ? "Array" !== c.util.type(a[d]) || b[c.util.objId(a[d])] || (b[c.util.objId(a[d])] = !0, c.languages.DFS(a[d], f, d, b)) : (b[c.util.objId(a[d])] = !0, c.languages.DFS(a[d], f, null, b)))
                    }
                },
                plugins: {},
                ...
                highlightAllUnder: function (a, f, b) {
                    ...
                    }, c.hooks.run("before-highlightall", b), a = b.elements || a.querySelectorAll(b.selector);
                ...
                highlightElement: function (a, f, g) {
                    ...
                    k && (d = (k.className.match(b) || [, ""])[1].toLowerCase(), e = c.languages[d]), a.className = a.className.replace(b, "").replace(/\s+/g, " ") + " language-" + d, a.parentNode && (k = a.parentNode, /pre/i.test(k.nodeName) && (k.className = k.className.replace(b, "").replace(/\s+/g, " ") + " language-" + d));
                    var h = {
                        element: a,
                        language: d,
                        grammar: e,
                    ...
                    c.hooks.run("before-sanity-check", h), h.code && h.grammar ? (c.hooks.run("before-highlight", h), f && _self.Worker ? ((a = new Worker(c.filename)).onmessage = function (a) {
                        h.highlightedCode = a.data, c.hooks.run("before-insert", h), h.element.innerHTML = h.highlightedCode, g && g.call(h.element), c.hooks.run("after-highlight", h), c.hooks.run("complete", h)
                    }, a.postMessage(JSON.stringify({
                        language: h.language,
                        code: h.code,
                        immediateClose: !0
                    }))) : (h.highlightedCode = c.highlight(h.code, h.grammar, h.language), c.hooks.run("before-insert", h), h.element.innerHTML = h.highlightedCode, g && g.call(a), c.hooks.run("after-highlight", h), c.hooks.run("complete", h))) : (h.code && (c.hooks.run("before-highlight", h), h.element.textContent = h.code, c.hooks.run("after-highlight", h)), c.hooks.run("complete", h))
                },
                highlight: function (a, b, g) {
                    return a = {
                        ...
                        grammar: b,
                        language: g
                    }, c.hooks.run("before-tokenize", a), a.tokens = c.tokenize(a.code, a.grammar), c.hooks.run("after-tokenize", a), d.stringify(c.util.encode(a.tokens), a.language)
                },
                                    ...
                                    if (!(n instanceof f)) {
                                        if (z && q != b.length - 1) {
                                            ...
                                            var v = m.index + (C ? m[1].length : 0),
                                                ...
                                                t = q;
                                            n = u;
                                            for (var E = b.length; t < E && (n < y || !b[t].type && !b[t - 1].greedy); ++t) v >= (n += b[t].length) && (++q, u = n);
                                            if (b[q] instanceof f) continue;
                                            t -= q, n = a.slice(u, n), m.index -= u
                                        } else p.lastIndex = 0, m = p.exec(n), t = 1;
                                        if (m && (C && (A = m[1] ? m[1].length : 0), y = (v = m.index + A) + (m = m[0].slice(A)).length, v = n.slice(0, v), y = n.slice(y), n = [q, t], v && (++q, u += v.length, n.push(v)), m = new f(l, B ? c.tokenize(m, B) : m, D, m, z), n.push(m), y && n.push(y), Array.prototype.splice.apply(b, n), 1 != t && c.matchGrammar(a, b, g, q, u, !0, l)), k) break
                                    }
                                }
                            }
                        }
                ...
                tokenize: function (a, b, d) {
                    ...
                    return c.matchGrammar(a, d, b, 0, 0, !1), d
                },
                hooks: {
                    all: {},
                    add: function (a, b) {
            ...
            d = c.Token = function (a, b, d, c, e) {
                this.type = a, this.content = b, this.alias = d, this.length = 0 | (c || "").length, this.greedy = !!e
            };
        if (d.stringify = function (a, b, g) {
                ...
                return a.alias && (g = "Array" === c.util.type(a.alias) ? a.alias : [a.alias], Array.prototype.push.apply(f.classes, g)), c.hooks.run("wrap", f), g = Object.keys(f.attributes).map((function (a) {
                    return a + '="' + (f.attributes[a] || "").replace(/"/g, "&quot;") + '"'
                })).join(" "), "<" + f.tag + ' class="' + f.classes.join(" ") + '"' + (g ? " " + g : "") + ">" + f.content + "</" + f.tag + ">"
            }, !_self.document) return _self.addEventListener ? (c.disableWorkerMessageHandler || _self.addEventListener("message", (function (a) {
            var b = (a = JSON.parse(a.data)).language,
                d = a.immediateClose;
            _self.postMessage(c.highlight(a.code, c.languages[b], b)), d && _self.close()
        }), !1), _self.Prism) : _self.Prism;
        var k = document.currentScript || [].slice.call(document.getElementsByTagName("script")).pop();
        return k && (c.filename = k.src, c.manual || k.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(c.highlightAll) : window.setTimeout(c.highlightAll, 16) : document.addEventListener("DOMContentLoaded", c.highlightAll))), _self.Prism
    }();
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
        ...
        entity: /&#?[\da-z]{1,8};/i
    }, Prism.languages.markup.tag.inside["attr-value"].inside.entity = Prism.languages.markup.entity, Prism.hooks.add("wrap", (function (b) {
    ...
    }), delete Prism.languages.c["class-name"], delete Prism.languages.c.boolean, Prism.languages.aspnet = Prism.languages.extend("markup", {
        "page-directive tag": {
            pattern: /<%\s*@.*%>/i,
            inside: {
    ...
    function (b) {
        ...
        b.languages.bash = {
            ...
            operator: /&&?|\|\|?|==?|!=?|<<<?|>>|<=?|>=?|=~/,
            punctuation: /\$?\(\(?|\)\)?|\.\.|[{}[\];]/
        }, (e = e.variable[1].inside).string = b.languages.bash.string, e.function = b.languages.bash.function, e.keyword = b.languages.bash.keyword, e.boolean = b.languages.bash.boolean, e.operator = b.languages.bash.operator, e.punctuation = b.languages.bash.punctuation, b.languages.shell = b.languages.bash
    ...
    }(Prism), Prism.languages["markup-templating"] = {}, Object.defineProperties(Prism.languages["markup-templating"], {
        buildPlaceholders: {
            value: function (b, e, c, d) {
                b.language === e && (b.tokenStack = [], b.code = b.code.replace(c, (function (c) {
                    ...
                    return b.tokenStack[a] = c, "___" + e.toUpperCase() + a + "___"
                                ...
                                for (var f = 0; f < a.length; f++) {
                                    ...
                                    if ("string" == typeof g || g.content && "string" == typeof g.content) {
                                        ...
                                        if (-1 < h) {
                                            ...
                                            if (r = new Prism.Token(e, Prism.tokenize(r, b.grammar, e), "language-" + e, r), l = w.substring(h + ("___" + e.toUpperCase() + l + "___").length), x || l ? (x = [x, r, l].filter((function (a) {
                                                    return !!a
                                                })), k(x)) : x = r, "string" == typeof g ? Array.prototype.splice.apply(a, [f, 1].concat(x)) : g.content = x, c >= d.length) break
                                        }
    ...
    function (b) {
        ...
        b.languages.php["heredoc-string"].inside.interpolation = e, b.languages.php["double-quoted-string"].inside.interpolation = e, b.hooks.add("before-tokenize", (function (c) {
            /(?:<\?php|<\?)/gi.test(c.code) && b.languages["markup-templating"].buildPlaceholders(c, "php", /(?:<\?php|<\?)[\s\S]*?(?:\?>|$)/gi)
    ...
    function (b) {
        b.languages.smarty = {
            ...
            var c = !1;
            b.languages["markup-templating"].buildPlaceholders(e, "smarty", /\{\*[\s\S]*?\*\}|\{[\s\S]+?\}/g, (function (b) {
                return "{/literal}" === b && (c = !1), !c && ("{literal}" === b && (c = !0), !0)
            }))
            ...
            var b = /\n(?!$)/g,
                e = function (d) {
                    ...
                    if ("pre-wrap" === e || "pre-line" === e) {
                        ...
                        d = e.textContent.split(b), f || ((f = document.createElement("div")).className = "line-numbers-sizer", e.appendChild(f)), f.style.display = "block", d.forEach((function (b, c) {
                            f.textContent = b || "\n", b = f.getBoundingClientRect().height, a.children[c].style.height = b + "px"
            ...
            window.addEventListener("resize", (function () {
                ...
                if (c.code) {
                    ...
                    if (d && /pre/i.test(d.nodeName) && (a.test(d.className) || a.test(c.element.className)) && !c.element.querySelector(".line-numbers-rows")) {
                        a.test(c.element.className) && (c.element.className = c.element.className.replace(a, " ")), a.test(d.className) || (d.className += " line-numbers"), a = c.code.match(b);
                        var f = Array((a ? a.length + 1 : 1) + 1);
                        f = f.join("<span></span>"), (a = document.createElement("span")).setAttribute("aria-hidden", "true"), a.className = "line-numbers-rows", a.innerHTML = f, d.hasAttribute("data-start") && (d.style.counterReset = "linenumber " + (parseInt(d.getAttribute("data-start"), 10) - 1)), c.element.appendChild(a), e(d), Prism.hooks.run("line-numbers", c)
                    }
                }
            })), Prism.hooks.add("line-numbers", (function (b) {
                b.plugins = b.plugins || {}, b.plugins.lineNumbers = !0
            })), Prism.plugins.lineNumbers = {
                getLine: function (b, c) {
                    if ("PRE" === b.tagName && b.classList.contains("line-numbers")) {
                        var a = b.querySelector(".line-numbers-rows"),
                            f = (b = parseInt(b.getAttribute("data-start"), 10) || 1) + (a.children.length - 1);
                        return c < b && (c = b), c > f && (c = f), a.children[c - b]
                    }
                }
            }
        }
        ...
        if ("undefined" != typeof self && self.Prism && self.document) {
            ...
            var d = Prism.plugins.toolbar.registerButton = function (a, c) {
                    b.push(e[a] = "function" == typeof c ? c : function (b) {
                        if ("function" == typeof c.onClick) {
                            ...
                            a.type = "button", a.addEventListener("click", (function () {
                                c.onClick.call(this, b)
                            }))
                        } else "string" == typeof c.url ? (a = document.createElement("a")).href = c.url : a = document.createElement("span");
                        return a.textContent = c.text, a
                    })
                },
                k = Prism.plugins.toolbar.hook = function (a) {
                    ...
                    if (d && /pre/i.test(d.nodeName) && !d.parentNode.classList.contains("code-toolbar")) {
                        ...
                        g.classList.add("code-toolbar"), d.parentNode.insertBefore(g, d), g.appendChild(d), (d = document.createElement("div")).classList.add("shelter"), g.appendChild(d);
                        var k = document.createElement("div");
                        k.classList.add("toolbar"), document.body.hasAttribute("data-toolbar-order") && (b = document.body.getAttribute("data-toolbar-order").split(",").map((function (a) {
                            return e[a] || c
                        }))), b.forEach((function (b) {
                            if (b = b(a)) {
                                var c = document.createElement("div");
                                c.classList.add("toolbar-item"), c.appendChild(b), k.appendChild(c)
                            }
                        })), g.appendChild(k)
                    }
                };
            d("label", (function (a) {
                if ((a = a.element.parentNode) && /pre/i.test(a.nodeName) && a.hasAttribute("data-label")) {
                    ...
                    return c ? c = c.content : (a.hasAttribute("data-url") ? (c = document.createElement("a")).href = a.getAttribute("data-url") : c = document.createElement("span"), c.textContent = b), c
                }
        ...
        if ("undefined" != typeof self && self.Prism && self.document)
            if (Prism.plugins.toolbar) {
                ...
                Prism.plugins.toolbar.registerButton("show-language", (function (e) {
                    ...
                    if (c && /pre/i.test(c.nodeName) && (e = c.getAttribute("data-language") || b[e.language] || e.language && e.language.substring(0, 1).toUpperCase() + e.language.substring(1))) return (c = document.createElement("span")).textContent = e, c
                }))
                ...
                if (!b) {
                    ...
                    c.onload = function () {
                        if (b = window.ClipboardJS)
                            for (; e.length;) e.pop()()
                    }, c.src = "https://cdn.jsdelivr.net/npm/clipboard@2.0.6/dist/clipboard.min.js", d.appendChild(c)
                }
                Prism.plugins.toolbar.registerButton("copy-to-clipboard", (function (c) {
                    function a() {
                        ...
                        a.on("success", (function () {
                            g.innerHTML = '<i class="fontello fontello-tags" id="btn-copy-code"style="font-style:normal;"> 已复制</i>', d()
                        })), a.on("error", (function () {
                            g.textContent = "Press Ctrl+C to copy", d()
                        }))
                    }
                    ...
                    return g.innerHTML = '<i class="fontello fontello-tags" id="btn-copy-code"style="font-style:normal;"> 复制</i>', b ? a() : e.push(a), g
                }))
